...
public class ColorPickerDialog {
    ...
    private final int[] defaultColorList = {
        ...
        //amber
        0xFFFF6F00, 0xFFFF8F00, 0xFFFFA000, 0xFFFFB300, 0xFFFFC107, 0xFFFFCA28, 0xFFFFD54F, 0xFFFFE082,
        //yellow
    ...
    private class GridPickerView extends GridView {
        ...
        void initGridView () {
            ...
            // Set the selected color from the gridview
    ...
    private class CirclePickerView extends View {
        ...
        void initCirclePicker() {
            ...
            //external radius  (0.9f = 90% of dialog)
        ...
        protected void onDraw(Canvas canvas) {
            ...
            */
            ...
            //draw cursor for circle palette
            ...
            //draw cursor for rectangular gradient
